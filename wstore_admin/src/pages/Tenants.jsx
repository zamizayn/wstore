...
export default function Tenants() {
    ...
    const handleSubmit = async (e) => {
        ...
        if (res.ok) {
            setModalOpen(false);
            setEditingId(null);
            setFormData({ name: '', phoneNumberId: '', whatsappToken: '', wabaId: '', username: '', password: '', isActive: true });
            fetchTenants();
        }
    };
            ...
            <div className="content-view active">
                ...
                {tenants.length === 0 && (
                    <div style={{textAlign: 'center', padding: '100px 0', color: 'var(--text-muted)'}}>
                        ...
                        <button className="btn-primary" style={{marginTop: '20px'}} onClick={() => setModalOpen(true)}>Add Tenant Now</button>
                    </div>
                )}
            </div>

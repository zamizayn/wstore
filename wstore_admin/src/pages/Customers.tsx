...
import { Send, Users, CheckSquare, Square, MessageSquare, History, ShoppingBag, X, Clock } from 'lucide-react';
    ...
    return (
        <div className="dashboard-content">
            ...
            <div className="white-card">
                ...
                {customers.length === 0 && (
                    <EmptyState icon={<Users size={48} />} title="No customers found in your database." />
                )}
